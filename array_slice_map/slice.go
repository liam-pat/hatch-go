...
/**
array_slice_map := [...]int{10,23,44,55,66}
slice := array_slice_map[0:3:5]
...
func main() {
	...
	fmt.Println("array_slice_map: ", array)
	fmt.Println("slice: ", slice)
	fmt.Println("---------------")
...
/**
different from array_slice_map to slice
array_slice_map : length cap always const
